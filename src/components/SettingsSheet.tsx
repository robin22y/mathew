  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed bottom-0 left-0 right-0 bg-neutral-900 rounded-t-2xl z-50 max-w-sm mx-auto">
        <div className="p-6">
          <h2 className="text-lg font-semibold text-neutral-100 mb-6">PIN & Privacy</h2>
